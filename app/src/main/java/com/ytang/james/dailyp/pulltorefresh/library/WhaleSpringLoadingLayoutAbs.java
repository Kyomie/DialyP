...
public abstract class WhaleSpringLoadingLayoutAbs extends AbsPullToRefreshAnimationLayout {
    ...
    public WhaleSpringLoadingLayoutAbs(Context context, final PullToRefreshBase.Mode mode,
        ...
        LayoutInflater.from(context).inflate(R.layout.refreshable_whale_spring_view, this);
        mAnimationHeaderView = (WhaleSpringAnimationView) findViewById(R.id.refresh_header_view);
        mAnimationImageView = (ImageView) findViewById(R.id.refresh_image_view);
    ...
    public final void refreshing() {
        ...
        if (mUseIntrinisicAnimation) {
            ...
            mAnimationImageView.setImageResource(R.drawable.refreshable_widget_spring);
            mAnimationImageView.setVisibility(View.VISIBLE);
            animationDrawable = (AnimationDrawable) mAnimationImageView.getDrawable();
