package com.ytang.james.dailyp.common.view.tab;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        indicatorColor = a.getColor(R.styleable.PagerSlidingTabStrip_pIndicatorColor, indicatorColor);
        underlineColor = a.getColor(R.styleable.PagerSlidingTabStrip_pUnderlineColor, underlineColor);
        dividerColor = a.getColor(R.styleable.PagerSlidingTabStrip_pDividerColor, dividerColor);
        indicatorHeight =
                a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pIndicatorHeight, indicatorHeight);
        underlineHeight =
                a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pUnderlineHeight, underlineHeight);
        dividerPadding =
                a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pDividerPadding, dividerPadding);
        tabPadding =
                a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pTabPaddingLeftRight, tabPadding);
        tabBackgroundResId =
                a.getResourceId(R.styleable.PagerSlidingTabStrip_pTabBackground, tabBackgroundResId);
        shouldExpand = a.getBoolean(R.styleable.PagerSlidingTabStrip_pShouldExpand, shouldExpand);
        scrollOffset =
                a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pScrollOffset, scrollOffset);
        textAllCaps = a.getBoolean(R.styleable.PagerSlidingTabStrip_pTextAllCaps, textAllCaps);
        tabTextColorStateList = a.getColorStateList(R.styleable.PagerSlidingTabStrip_pTabTextColor);
        tabTextSize = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pTabTextSize,
                tabTextSize);
        a.recycle();
    ...
    public void setViewPager(final ViewPager viewPager) {
        ...
        if (tabsContainer.getChildAt(pager.getCurrentItem()) != null) {
