...
public class FlipLoadingLayout extends ImageLoadingLayout {
    ...
    @Override
    protected void loadingDrawableImpl(Drawable imageDrawable) {
     ...
     */
        ...
        if (null != imageDrawable) {
            ...
            lp.width = lp.height = Math.max(imageDrawable.getIntrinsicWidth(),
