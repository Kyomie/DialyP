...
import com.ytang.james.dailyp.pulltorefresh.library.PullToRefreshBase.Mode;
import com.ytang.james.dailyp.pulltorefresh.library.PullToRefreshBase.State;
import com.ytang.james.dailyp.pulltorefresh.library.PullToRefreshBase.OnPullEventListener;
import com.ytang.james.dailyp.pulltorefresh.library.PullToRefreshBase.OnRefreshListener;
import com.ytang.james.dailyp.pulltorefresh.library.PullToRefreshBase.OnRefreshListener2;
...
public interface IPullToRefresh<T extends View> {
     ...
     * use <code>getCurrentMode()</code> to
     ...
     *          - Drawable to display
     * @param mode
     *          - Controls which Header/Footer Views will be updated. <code>Mode.BOTH</code> will
     *          update all available, other values
